...
const Main = () => {
  return (
    <div className="md:grid md:grid-cols-2 bg-light-cyan-neuro lg:h-[70vh] md:h-[50vh]">
      <div className="bg-[url(./assets/main.png)] w-full md:h-full h-72 bg-contain bg-no-repeat md:bg-right-top bg-right md:m-0 mt-16 md:order-last">
      </div>
      <div className="flex flex-col justify-center md:pt-16 md:pb-0 p-8 md:px-16 px-4">
