...
const Main = () => {
  return (
    <div className="md:grid md:grid-cols-2 bg-light-cyan-neuro">
      <div className="md:h-auto sm:h-[70vw] h-[100vw] md:px-16 md:py-12 md:pt-28 pt-24 py-8 bg-gradient-to-r from-dark-cyan-neuro to-cyan-neuro md:rounded-none md:rounded-bl-[800px] rounded-none md:order-last">
        <div className="w-full h-full bg-[url(./assets/main.webp)] bg-contain bg-center bg-no-repeat"></div>
      </div>
      <div className="flex flex-col justify-center md:pt-48 md:pb-32 sm:px-16 px-4 py-8">
        <h1 className="text-dark-neuro text-3xl">
          Agende uma avaliação e venha{" "}
          <span className="font-bold bg-gradient-to-r from-dark-cyan-neuro to-cyan-neuro text-transparent bg-clip-text">
