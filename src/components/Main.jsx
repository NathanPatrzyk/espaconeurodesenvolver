...
const Main = () => {
  return (
    <div>
      ...
      >
        <div className="md:w-[50vw] flex flex-col md:ps-16 px-4 md:px-0 md:pt-0">
          <Motion>
        ...
        <div className="md:w-[50vw] flex justify-center items-center md:rounded-none md:rounded-bl-[800px] rounded-none md:py-12 py-0">
          <div className="flex-1 flex items-center justify-center md:px-16 md:py-12 py-0 pb-8">
