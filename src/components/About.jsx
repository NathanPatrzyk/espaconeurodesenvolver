import IconMissao from "../assets/missao.svg";
import IconVisao from "../assets/visao.svg";
import IconValores from "../assets/valores.svg";
  ...
  return (
    <section className="flex md:flex-row flex-col gap-8 bg-light-neuro md:px-16 px-4 md:py-12 py-8">
      <div className="px-8 py-4 border-4 border-dark-neuro hover:border-cyan-neuro border-opacity-20 rounded-lg">
        <img className="mx-auto" src={IconMissao} />
      ...
      <div className="px-8 py-4 border-4 border-dark-neuro hover:border-cyan-neuro border-opacity-20 rounded-lg">
        <img className="mx-auto" src={IconVisao} />
        <h2 className="py-4 text-center font-bold bg-gradient-to-r from-dark-cyan-neuro to-cyan-neuro text-transparent bg-clip-text text-2xl">
          Visão
        </h2>
        <p className="text-dark-neuro">
      ...
      <div className="px-8 py-4 border-4 border-dark-neuro hover:border-cyan-neuro border-opacity-20 rounded-lg">
        <img className="mx-auto" src={IconValores} />
        <h2 className="py-4 text-center font-bold bg-gradient-to-r from-dark-cyan-neuro to-cyan-neuro text-transparent bg-clip-text text-2xl">
          Valores
        </h2>
        <p className="text-dark-neuro">
