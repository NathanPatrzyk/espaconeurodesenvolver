...
const Nav = () => {
  ...
  return (
    <div className="bg-white bg-opacity-50 md:px-8 px-4 py-3 w-full md:flex items-center fixed top-0 left-0">
      ...
      <div
        className={`bg-white md:bg-opacity-0 bg-opacity-50 md:p-0 p-2 pt-4 md:flex md:gap-4 md:justify-end absolute md:static md:z-auto z-[-1] left-0 w-full transition-all duration-500 ease-in ${
