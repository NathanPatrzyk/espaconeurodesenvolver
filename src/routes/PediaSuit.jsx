    ...
    <div className="pt-16">
      ...
      <section className="flex md:flex-row flex-col bg-light-neuro">
        <div className="flex md:ps-16 md:py-12 md:pe-4 pt-8 pb-2 px-4">
          <Motion><img className="mx-auto w-40 h-40" src={IconChampion} /></Motion>
        </div>
          ...
          <div className="flex-1 flex flex-col justify-center md:py-32 md:px-16 px-4 py-8">
            <Motion>
              <h1 className="text-dark-neuro text-2xl">
                Agende uma avaliação conosco e descubra como o PediaSuit pode ser
                a chave para conquistar novos horizontes na neuroreabilitação de
                seu filho(a)!
              </h1>
              <div className="pt-6">
                <Link
